...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	...
	// ブロックしてたら中断
		...
		if (((this.utilityService.isBlockedHost(fetchedMeta.blockedHosts, this.utilityService.extractDbHost(uri)))  && !(process.env.SAFE_LIST=='true')) ||
			(!(this.utilityService.isBlockedHost(fetchedMeta.blockedHosts, this.utilityService.extractDbHost(uri))) &&  (process.env.SAFE_LIST=='true')))
			 return null;
